...
import net.minecraft.server.v1_16_R2.ChunkCache;
...
import net.minecraft.server.v1_16_R2.PathMode;
import net.minecraft.server.v1_16_R2.PathPoint;
import net.minecraft.server.v1_16_R2.PathType;
import net.minecraft.server.v1_16_R2.Pathfinder;
import net.minecraft.server.v1_16_R2.PathfinderAbstract;
    ...
    protected void a(Vec3D var0) {
        ...
        if (this.c != null && !this.c.c()) {
            ...
            if (var1.equals(this.h)) {
                ...
                this.k = (this.a.dM() > 0.0F) ? (var2 / this.a.dM() * 1000.0D) : 0.0D;
            }

...
public class TropicalFishController extends MobEntityController {
    ...
    public static class EntityTropicalFishNPC extends TropicalFish implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

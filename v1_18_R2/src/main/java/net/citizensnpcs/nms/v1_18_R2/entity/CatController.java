...
public class CatController extends MobEntityController {
    ...
    public static class EntityCatNPC extends Cat implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

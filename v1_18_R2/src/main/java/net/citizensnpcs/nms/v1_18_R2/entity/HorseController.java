...
public class HorseController extends MobEntityController {
    ...
    public static class EntityHorseNPC extends Horse implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

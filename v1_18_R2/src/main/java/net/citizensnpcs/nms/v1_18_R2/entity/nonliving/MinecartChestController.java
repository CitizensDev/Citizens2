...
public class MinecartChestController extends MobEntityController {
    ...
    public static class EntityMinecartChestNPC extends MinecartChest implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

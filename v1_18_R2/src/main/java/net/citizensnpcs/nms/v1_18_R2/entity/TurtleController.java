...
public class TurtleController extends MobEntityController {
    ...
    public static class EntityTurtleNPC extends Turtle implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

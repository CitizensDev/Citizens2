...
public class ChestRaftController extends AbstractEntityController {
    ...
    protected org.bukkit.entity.Entity createEntity(Location at, NPC npc) {
        final EntityChestRaftNPC handle = new EntityChestRaftNPC(EntityTypes.BAMBOO_CHEST_RAFT,
    ...
    public static class EntityChestRaftNPC extends ChestRaft implements NPCHolder {
        ...
        public EntityChestRaftNPC(EntityType<? extends ChestRaft> types, Level level, Supplier<Item> supplier) {

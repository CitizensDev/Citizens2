...
public class EvokerFangsController extends MobEntityController {
    public EvokerFangsController() {
        super(EntityEvokerFangsNPC.class, EntityTypes.EVOKER_FANGS);
    }
    ...
    public static class EntityEvokerFangsNPC extends EvokerFangs implements NPCHolder {
        ...
        @Override
        public InteractionResult interact(Player entityhuman, InteractionHand enumhand, Vec3 vec3d) {
            if (npc == null)
                return super.interact(entityhuman, enumhand, vec3d);

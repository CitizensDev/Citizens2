package net.citizensnpcs.nms.v26_3_R1.entity.nonliving;
...
public class RaftController extends AbstractEntityController {
    ...
    protected org.bukkit.entity.Entity createEntity(Location at, NPC npc) {
        final EntityRaftNPC handle = new EntityRaftNPC(EntityTypes.BAMBOO_RAFT,
                ((CraftWorld) at.getWorld()).getHandle(), () -> Items.BAMBOO_RAFT, npc);
    ...
    public static class EntityRaftNPC extends Raft implements NPCHolder {
        ...
        private void floatRaft() {
            ...
            if (this.lastStatus == net.minecraft.world.entity.vehicle.boat.Raft.Status.IN_AIR
                    && this.status != net.minecraft.world.entity.vehicle.boat.Raft.Status.IN_AIR
                    && this.status != net.minecraft.world.entity.vehicle.boat.Raft.Status.ON_LAND) {
                ...
                this.status = net.minecraft.world.entity.vehicle.boat.Raft.Status.IN_WATER;
            } else {
                if (this.status == net.minecraft.world.entity.vehicle.boat.Raft.Status.IN_WATER) {
                    d1 = (this.waterLevel - this.getY()) / this.getBbHeight();
                    this.invFriction = 0.9F;
                } else if (this.status == net.minecraft.world.entity.vehicle.boat.Raft.Status.UNDER_FLOWING_WATER) {
                    d0 = -7.0E-4;
                    this.invFriction = 0.9F;
                } else if (this.status == net.minecraft.world.entity.vehicle.boat.Raft.Status.UNDER_WATER) {
                    d1 = 0.009999999776482582;
                    this.invFriction = 0.45F;
                } else if (this.status == net.minecraft.world.entity.vehicle.boat.Raft.Status.IN_AIR) {
                    this.invFriction = 0.9F;
                } else if (this.status == net.minecraft.world.entity.vehicle.boat.Raft.Status.ON_LAND) {
                ...
                for (int l1 = k; l1 < l; ++l1) {
                    for (int i2 = i1; i2 < j1; ++i2) {
                        ...
                        if (fluid.is(FluidTags.WATER) && d0 < blockposition_mutableblockposition.getY()
                            ...
                            if (!fluid.isSource())
                                return net.minecraft.world.entity.vehicle.boat.Raft.Status.UNDER_FLOWING_WATER;
                            flag = true;
                        }
                    }
                }

...
import net.citizensnpcs.nms.v1_16_R1.entity.BlazeController;
import net.citizensnpcs.nms.v1_16_R1.entity.CatController;
import net.citizensnpcs.nms.v1_16_R1.entity.CaveSpiderController;
import net.citizensnpcs.nms.v1_16_R1.entity.ChickenController;
import net.citizensnpcs.nms.v1_16_R1.entity.CodController;
import net.citizensnpcs.nms.v1_16_R1.entity.CowController;
import net.citizensnpcs.nms.v1_16_R1.entity.CreeperController;
import net.citizensnpcs.nms.v1_16_R1.entity.DolphinController;
import net.citizensnpcs.nms.v1_16_R1.entity.DrownedController;
import net.citizensnpcs.nms.v1_16_R1.entity.EnderDragonController;
import net.citizensnpcs.nms.v1_16_R1.entity.EndermanController;
import net.citizensnpcs.nms.v1_16_R1.entity.EndermiteController;
import net.citizensnpcs.nms.v1_16_R1.entity.EntityHumanNPC;
import net.citizensnpcs.nms.v1_16_R1.entity.EvokerController;
import net.citizensnpcs.nms.v1_16_R1.entity.FoxController;
import net.citizensnpcs.nms.v1_16_R1.entity.GhastController;
...
import net.citizensnpcs.nms.v1_16_R1.entity.HorseSkeletonController;
import net.citizensnpcs.nms.v1_16_R1.entity.HorseZombieController;
import net.citizensnpcs.nms.v1_16_R1.entity.HumanController;
import net.citizensnpcs.nms.v1_16_R1.entity.IllusionerController;
import net.citizensnpcs.nms.v1_16_R1.entity.IronGolemController;
import net.citizensnpcs.nms.v1_16_R1.entity.LlamaController;
import net.citizensnpcs.nms.v1_16_R1.entity.MagmaCubeController;
import net.citizensnpcs.nms.v1_16_R1.entity.MushroomCowController;
import net.citizensnpcs.nms.v1_16_R1.entity.OcelotController;
import net.citizensnpcs.nms.v1_16_R1.entity.PandaController;
import net.citizensnpcs.nms.v1_16_R1.entity.ParrotController;
import net.citizensnpcs.nms.v1_16_R1.entity.PhantomController;
import net.citizensnpcs.nms.v1_16_R1.entity.PigController;
import net.citizensnpcs.nms.v1_16_R1.entity.PigZombieController;
import net.citizensnpcs.nms.v1_16_R1.entity.PiglinController;
import net.citizensnpcs.nms.v1_16_R1.entity.PillagerController;
import net.citizensnpcs.nms.v1_16_R1.entity.PolarBearController;
import net.citizensnpcs.nms.v1_16_R1.entity.PufferFishController;
import net.citizensnpcs.nms.v1_16_R1.entity.RabbitController;
import net.citizensnpcs.nms.v1_16_R1.entity.RavagerController;
import net.citizensnpcs.nms.v1_16_R1.entity.SalmonController;
import net.citizensnpcs.nms.v1_16_R1.entity.SheepController;
import net.citizensnpcs.nms.v1_16_R1.entity.ShulkerController;
import net.citizensnpcs.nms.v1_16_R1.entity.SilverfishController;
import net.citizensnpcs.nms.v1_16_R1.entity.SkeletonController;
import net.citizensnpcs.nms.v1_16_R1.entity.SkeletonStrayController;
import net.citizensnpcs.nms.v1_16_R1.entity.SkeletonWitherController;
import net.citizensnpcs.nms.v1_16_R1.entity.SlimeController;
import net.citizensnpcs.nms.v1_16_R1.entity.SnowmanController;
import net.citizensnpcs.nms.v1_16_R1.entity.SpiderController;
import net.citizensnpcs.nms.v1_16_R1.entity.SquidController;
import net.citizensnpcs.nms.v1_16_R1.entity.StriderController;
import net.citizensnpcs.nms.v1_16_R1.entity.TraderLlamaController;
import net.citizensnpcs.nms.v1_16_R1.entity.TropicalFishController;
import net.citizensnpcs.nms.v1_16_R1.entity.TurtleController;
import net.citizensnpcs.nms.v1_16_R1.entity.VexController;
import net.citizensnpcs.nms.v1_16_R1.entity.VillagerController;
import net.citizensnpcs.nms.v1_16_R1.entity.VindicatorController;
import net.citizensnpcs.nms.v1_16_R1.entity.WanderingTraderController;
import net.citizensnpcs.nms.v1_16_R1.entity.WitchController;
import net.citizensnpcs.nms.v1_16_R1.entity.WitherController;
import net.citizensnpcs.nms.v1_16_R1.entity.WolfController;
import net.citizensnpcs.nms.v1_16_R1.entity.ZoglinController;
import net.citizensnpcs.nms.v1_16_R1.entity.ZombieController;
import net.citizensnpcs.nms.v1_16_R1.entity.ZombieHuskController;
import net.citizensnpcs.nms.v1_16_R1.entity.ZombieVillagerController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.AreaEffectCloudController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ArmorStandController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.BoatController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.DragonFireballController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.EggController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.EnderCrystalController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.EnderPearlController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.EnderSignalController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.EvokerFangsController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.FallingBlockController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.FireworkController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.FishingHookController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ItemController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ItemFrameController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.LargeFireballController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.LeashController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.LlamaSpitController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartChestController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartCommandController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartFurnaceController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartHopperController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartRideableController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.MinecartTNTController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.PaintingController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ShulkerBulletController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.SmallFireballController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.SnowballController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.SpectralArrowController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.TNTPrimedController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ThrownExpBottleController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ThrownPotionController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.ThrownTridentController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.TippedArrowController;
import net.citizensnpcs.nms.v1_16_R1.entity.nonliving.WitherSkullController;
import net.citizensnpcs.nms.v1_16_R1.network.EmptyChannel;
import net.citizensnpcs.nms.v1_16_R1.trait.Commands;
...
import net.minecraft.server.v1_16_R1.BossBattleServer;
...
import net.minecraft.server.v1_16_R1.RegistryBlocks;
...
public class NMSImpl implements NMSBridge {
    ...
    private MCNavigator getTargetNavigator(final org.bukkit.entity.Entity entity, final NavigatorParameters params,
        ...
        net.minecraft.server.v1_16_R1.Entity raw = getHandle(entity);
        raw.c(true);
    ...
    public void look(org.bukkit.entity.Entity entity, Location to, boolean headOnly, boolean immediate) {
        ...
        if (handle instanceof EntityInsentient) {
            ((EntityInsentient) handle).getControllerLook().a(to.getX(), to.getY(), to.getZ(),
                    ((EntityInsentient) handle).eq(), ((EntityInsentient) handle).eo());

            while (((EntityLiving) handle).aJ >= 180F) {
                ((EntityLiving) handle).aJ -= 360F;
            }
            while (((EntityLiving) handle).aJ < -180F) {
                ((EntityLiving) handle).aJ += 360F;
            }
    ...
    public void look(org.bukkit.entity.Entity from, org.bukkit.entity.Entity to) {
        ...
        if (BAD_CONTROLLER_LOOK.contains(handle.getBukkitEntity().getType())) {
            ...
            ((EntityInsentient) handle).getControllerLook().a(target, ((EntityInsentient) handle).eq(),
                    ((EntityInsentient) handle).eo());
            while (((EntityLiving) handle).aJ >= 180F) {
                ((EntityLiving) handle).aJ -= 360F;
            }
            while (((EntityLiving) handle).aJ < -180F) {
    ...
    public static void flyingMoveLogic(EntityLiving entity, Vec3D vec3d) {
        if (entity.doAITick() || entity.cr()) {
            ...
            if (entity.isInWater() /*&& entity.cS() !entityHuman.abilities.isFlying*/ && !entity.a(fluid.getType())) {
                ...
                if (entity.positionChanged
                        && entity.e(vec3d2.x, vec3d2.y + 0.6000000238418579D - entity.locY() + d1, vec3d2.z))
                    entity.setMot(vec3d2.x, 0.30000001192092896D, vec3d2.z);
            } else if (entity.aN() /*&& entity.cS() !entityHuman.abilities.isFlying*/ && !entity.a(fluid.getType())) {
                double d1 = entity.locY();
                entity.a(0.02F, vec3d);
                entity.move(EnumMoveType.SELF, entity.getMot());
                if (entity.b(TagsFluid.LAVA) <= entity.cw()) {
                    entity.setMot(entity.getMot().d(0.5D, 0.800000011920929D, 0.5D));
                ...
                if (entity.positionChanged
                        && entity.e(vec3d3.x, vec3d3.y + 0.6000000238418579D - entity.locY() + d1, vec3d3.z))
                    entity.setMot(vec3d3.x, 0.30000001192092896D, vec3d3.z);
                ...
                double d3 = Math.sqrt(entity.b(vec3d4));
                double d4 = vec3d5.f();
                ...
                if (entity.positionChanged && !entity.world.isClientSide) {
                    double d5 = Math.sqrt(entity.b(entity.getMot()));
                    double d6 = d3 - d5;
                ...
                BlockPosition blockposition = new BlockPosition(entity.locX(),
                        (entity.getBoundingBox()).minY - 0.5000001D, entity.locZ());// entity.an();
    ...
    private static final MethodHandle RABBIT_DATAWATCHER_FIELD = NMS.getGetter(EntityRabbit.class, "bv");

...
public abstract class MobEntityController extends AbstractEntityController {
    ...
    protected Entity createEntity(Location at, NPC npc) {
        ...
        net.minecraft.server.v1_16_R1.Entity entity = createEntityFromClass(type,
    ...
    private net.minecraft.server.v1_16_R1.Entity createEntityFromClass(Object... args) {
        try {
            return (net.minecraft.server.v1_16_R1.Entity) constructor.newInstance(args);
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
        }

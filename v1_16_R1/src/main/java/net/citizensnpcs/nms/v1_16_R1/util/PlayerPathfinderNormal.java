...
import net.minecraft.server.v1_16_R1.BlockCampfire;
import net.minecraft.server.v1_16_R1.BlockDoor;
import net.minecraft.server.v1_16_R1.BlockFenceGate;
import net.minecraft.server.v1_16_R1.BlockLeaves;
import net.minecraft.server.v1_16_R1.BlockMinecartTrackAbstract;
...
import net.minecraft.server.v1_16_R1.PathMode;
...
public class PlayerPathfinderNormal extends PlayerPathfinderAbstract {
    ...
    protected static PathType b(IBlockAccess var0, BlockPosition var1) {
        ...
        if (BlockDoor.h(var2) && !var2.get(BlockDoor.OPEN).booleanValue())

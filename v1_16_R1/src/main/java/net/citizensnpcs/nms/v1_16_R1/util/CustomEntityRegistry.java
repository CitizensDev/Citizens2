...
public class CustomEntityRegistry extends RegistryBlocks {
    ...
    public CustomEntityRegistry(RegistryBlocks<EntityTypes<?>> original) throws Throwable {
        super(original.a().getNamespace(), (ResourceKey<IRegistry<EntityTypes<?>>>) IREGISTRY_B.invoke(original),
                (Lifecycle) IREGISTRY_C.invoke(original));
    ...
    private static final MethodHandle IREGISTRY_B = NMS.getGetter(IRegistry.class, "b");
    private static final MethodHandle IREGISTRY_C = NMS.getGetter(IRegistry.class, "c");

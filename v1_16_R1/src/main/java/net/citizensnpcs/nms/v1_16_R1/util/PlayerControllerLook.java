...
public class PlayerControllerLook {
    ...
    public void a() {
        ...
        if (this.d) {
            ...
            this.a.yaw = this.a.aJ;
            while (this.a.aJ >= 180F) {
                this.a.aJ -= 360F;
            }
            while (this.a.aJ < -180F) {
                this.a.aJ += 360F;
            ...
            // this.a.yaw = MathHelper.b(this.a.yaw, this.a.aJ, 40F);
            // this.a.aK = this.a(this.a.aJ, this.a.aH, 10.0F);
        }
        if (!this.a.getNavigation().m()) {
            this.a.aK = MathHelper.b(this.a.aJ, this.a.aH, 75);
        }
    }

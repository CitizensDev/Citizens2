...
public class StriderController extends MobEntityController {
    ...
    @Override
    public Strider getBukkitEntity() {
        return (Strider) super.getBukkitEntity();
    }

    public static class EntityStriderNPC extends EntityStrider implements NPCHolder {
        private final CitizensNPC npc;

        public EntityStriderNPC(EntityTypes<? extends EntityStrider> types, World world) {
            this(types, world, null);
        }

        public EntityStriderNPC(EntityTypes<? extends EntityStrider> types, World world, NPC npc) {
            super(types, world);
    ...
    public static class StriderNPC extends CraftStrider implements NPCHolder {
        private final CitizensNPC npc;

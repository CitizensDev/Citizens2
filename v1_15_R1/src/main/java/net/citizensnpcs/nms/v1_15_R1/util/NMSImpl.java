...
import net.citizensnpcs.nms.v1_15_R1.entity.BlazeController;
import net.citizensnpcs.nms.v1_15_R1.entity.CatController;
import net.citizensnpcs.nms.v1_15_R1.entity.CaveSpiderController;
import net.citizensnpcs.nms.v1_15_R1.entity.ChickenController;
import net.citizensnpcs.nms.v1_15_R1.entity.CodController;
import net.citizensnpcs.nms.v1_15_R1.entity.CowController;
import net.citizensnpcs.nms.v1_15_R1.entity.CreeperController;
import net.citizensnpcs.nms.v1_15_R1.entity.DolphinController;
import net.citizensnpcs.nms.v1_15_R1.entity.DrownedController;
import net.citizensnpcs.nms.v1_15_R1.entity.EnderDragonController;
import net.citizensnpcs.nms.v1_15_R1.entity.EndermanController;
import net.citizensnpcs.nms.v1_15_R1.entity.EndermiteController;
import net.citizensnpcs.nms.v1_15_R1.entity.EntityHumanNPC;
import net.citizensnpcs.nms.v1_15_R1.entity.EvokerController;
import net.citizensnpcs.nms.v1_15_R1.entity.FoxController;
import net.citizensnpcs.nms.v1_15_R1.entity.GhastController;
import net.citizensnpcs.nms.v1_15_R1.entity.GiantController;
import net.citizensnpcs.nms.v1_15_R1.entity.GuardianController;
import net.citizensnpcs.nms.v1_15_R1.entity.GuardianElderController;
import net.citizensnpcs.nms.v1_15_R1.entity.HorseController;
import net.citizensnpcs.nms.v1_15_R1.entity.HorseDonkeyController;
import net.citizensnpcs.nms.v1_15_R1.entity.HorseMuleController;
import net.citizensnpcs.nms.v1_15_R1.entity.HorseSkeletonController;
import net.citizensnpcs.nms.v1_15_R1.entity.HorseZombieController;
import net.citizensnpcs.nms.v1_15_R1.entity.HumanController;
import net.citizensnpcs.nms.v1_15_R1.entity.IllusionerController;
import net.citizensnpcs.nms.v1_15_R1.entity.IronGolemController;
import net.citizensnpcs.nms.v1_15_R1.entity.LlamaController;
import net.citizensnpcs.nms.v1_15_R1.entity.MagmaCubeController;
import net.citizensnpcs.nms.v1_15_R1.entity.MushroomCowController;
import net.citizensnpcs.nms.v1_15_R1.entity.OcelotController;
import net.citizensnpcs.nms.v1_15_R1.entity.PandaController;
import net.citizensnpcs.nms.v1_15_R1.entity.ParrotController;
import net.citizensnpcs.nms.v1_15_R1.entity.PhantomController;
import net.citizensnpcs.nms.v1_15_R1.entity.PigController;
import net.citizensnpcs.nms.v1_15_R1.entity.PigZombieController;
import net.citizensnpcs.nms.v1_15_R1.entity.PillagerController;
import net.citizensnpcs.nms.v1_15_R1.entity.PolarBearController;
import net.citizensnpcs.nms.v1_15_R1.entity.PufferFishController;
import net.citizensnpcs.nms.v1_15_R1.entity.RabbitController;
import net.citizensnpcs.nms.v1_15_R1.entity.RavagerController;
import net.citizensnpcs.nms.v1_15_R1.entity.SalmonController;
import net.citizensnpcs.nms.v1_15_R1.entity.SheepController;
import net.citizensnpcs.nms.v1_15_R1.entity.ShulkerController;
import net.citizensnpcs.nms.v1_15_R1.entity.SilverfishController;
import net.citizensnpcs.nms.v1_15_R1.entity.SkeletonController;
import net.citizensnpcs.nms.v1_15_R1.entity.SkeletonStrayController;
import net.citizensnpcs.nms.v1_15_R1.entity.SkeletonWitherController;
import net.citizensnpcs.nms.v1_15_R1.entity.SlimeController;
import net.citizensnpcs.nms.v1_15_R1.entity.SnowmanController;
import net.citizensnpcs.nms.v1_15_R1.entity.SpiderController;
import net.citizensnpcs.nms.v1_15_R1.entity.SquidController;
import net.citizensnpcs.nms.v1_15_R1.entity.TraderLlamaController;
import net.citizensnpcs.nms.v1_15_R1.entity.TropicalFishController;
import net.citizensnpcs.nms.v1_15_R1.entity.TurtleController;
import net.citizensnpcs.nms.v1_15_R1.entity.VexController;
import net.citizensnpcs.nms.v1_15_R1.entity.VillagerController;
import net.citizensnpcs.nms.v1_15_R1.entity.VindicatorController;
import net.citizensnpcs.nms.v1_15_R1.entity.WanderingTraderController;
import net.citizensnpcs.nms.v1_15_R1.entity.WitchController;
import net.citizensnpcs.nms.v1_15_R1.entity.WitherController;
import net.citizensnpcs.nms.v1_15_R1.entity.WolfController;
import net.citizensnpcs.nms.v1_15_R1.entity.ZombieController;
import net.citizensnpcs.nms.v1_15_R1.entity.ZombieHuskController;
import net.citizensnpcs.nms.v1_15_R1.entity.ZombieVillagerController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.AreaEffectCloudController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.ArmorStandController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.BoatController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.DragonFireballController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.EggController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.EnderCrystalController;
...
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.ItemController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.ItemFrameController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.LargeFireballController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.LeashController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.LlamaSpitController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.MinecartChestController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.MinecartCommandController;
...
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.SmallFireballController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.SnowballController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.SpectralArrowController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.TNTPrimedController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.ThrownExpBottleController;
import net.citizensnpcs.nms.v1_15_R1.entity.nonliving.ThrownPotionController;
...
public class NMSImpl implements NMSBridge {
    ...
    public float getStepHeight(org.bukkit.entity.Entity entity) {
        return NMSImpl.getHandle(entity).H;
    }
    ...
    public void look(org.bukkit.entity.Entity entity, Location to, boolean headOnly, boolean immediate) {
        ...
        if (handle instanceof EntityInsentient) {
            ((EntityInsentient) handle).getControllerLook().a(to.getX(), to.getY(), to.getZ(),
                    ((EntityInsentient) handle).dW(), ((EntityInsentient) handle).dU());
    ...
    public void look(org.bukkit.entity.Entity from, org.bukkit.entity.Entity to) {
        ...
        if (BAD_CONTROLLER_LOOK.contains(handle.getBukkitEntity().getType())
            ...
            ((EntityInsentient) handle).getControllerLook().a(target, ((EntityInsentient) handle).dW(),
                    ((EntityInsentient) handle).dU());
            while (((EntityLiving) handle).aK >= 180F) {
                ((EntityLiving) handle).aK -= 360F;
            }
            while (((EntityLiving) handle).aK < -180F) {
    ...
    public static boolean fluidPush(NPC npc, Entity entity, net.minecraft.server.v1_15_R1.Tag<FluidType> tag) {
            ...
            if (!entity.isInWater() || entity instanceof EntityHuman && ((EntityHuman) entity).abilities.isFlying) {
                ...
                if (entity.aH() && (!(entity instanceof EntityHuman) || !((EntityHuman) entity).abilities.isFlying)) {
                    ...
                    if (entity.positionChanged
                            && entity.e(vec3d4.x, vec3d4.y + 0.6000000238418579D - entity.locY() + d1, vec3d4.z)) {
                    ...
                    BlockPosition blockposition = new BlockPosition(entity.locX(), entity.getBoundingBox().minY - 0.5D,
                            entity.locZ());

...
public class PlayerPathfinderNormal extends PlayerPathfinderAbstract {
    ...
    public PathPoint b() {
        ...
        if (this.e() && this.b.isInWater()) {
            ...
            for (IBlockData var2 = this.a.getType(varx); var2.getBlock() == Blocks.WATER
                    || var2.getFluid() == FluidTypes.WATER.a(false); var2 = this.a.getType(varx)) {
                ++var0;
        ...
        if (var5.isAir())
            ...
            if (var6 == Blocks.FIRE)
                ...
                return PathType.LEAVES;
                    ...
                    || var6 instanceof BlockFenceGate && !(Boolean) var5.get(BlockFenceGate.OPEN))
                return PathType.FENCE;
            else {

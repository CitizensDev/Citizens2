...
public class HoglinController extends MobEntityController {
    ...
    public static class EntityHoglinNPC extends Hoglin implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

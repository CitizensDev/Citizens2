...
public class EvokerController extends MobEntityController {
    ...
    public static class EntityEvokerNPC extends Evoker implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

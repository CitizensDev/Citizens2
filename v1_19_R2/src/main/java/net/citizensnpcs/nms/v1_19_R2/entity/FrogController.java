...
public class FrogController extends MobEntityController {
    ...
    public static class EntityFrogNPC extends Frog implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

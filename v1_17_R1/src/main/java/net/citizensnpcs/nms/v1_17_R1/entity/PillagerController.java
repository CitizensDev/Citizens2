...
public class PillagerController extends MobEntityController {
    ...
    public static class EntityPillagerNPC extends Pillager implements NPCHolder {@Override public boolean isPushable() { return npc == null ? super.isPushable() : npc.data().<Boolean> get(NPC.Metadata.COLLIDABLE, !npc.isProtected()); }

...
public abstract class MobEntityController extends AbstractEntityController {
    ...
    private net.minecraft.server.v1_11_R1.Entity createEntityFromClass(Object... args) {
        try {
            return (net.minecraft.server.v1_11_R1.Entity) constructor.newInstance(args);
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
        }
